...
"""
METODO CONSTRUCTOR.-Este metodo especial dentro de una clase y se utiliza para 
dar un valor a los atributos del objeto al crearlo, es el primer metodo que es 
ejecuta al crear el objeto y se manda llamar automicamente al crearlo, es 
decir este metodo puede recibir parametros al momento de crear el objeto

Cuando se crea un metodo contructor se utiliza la funcion init(), para que se 
llame automaticamente cada vez que se utiliza la clase para crear un nuevo
objeto.

El self es un parametro es una referencia a la instancia actual de 
"""

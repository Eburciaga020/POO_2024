...
METODO CONSTRUCTOR .- Este metodo especil dentro de 
"""
...
class Coches:
    ...
    #El encapsulamiento o visibilidad es importante por que a traves de del el es posible que python sepa como va a utilizar y manipular los atributos y metodods de la clase
    #Atributo publico
    atributo_publico = "soy un atributo publico"
    #Atributo privado
    __atributo_privado = "Soy un atributo privado"

    #NOTA 1 para utilizar un atributo privado es necesario usarlo en un metodo publicp
